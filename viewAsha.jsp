    ...
    <body> 
        ...
        <div class="services agileits-w3layouts">
            <div id="dispandiv" class="container">
                <h3 class="agileits-title1"> ASHA WORKERS LIST</h3>  
                <%
                    dbConnection.DbConnection obj = new dbConnection.DbConnection();

                    String pid = session.getAttribute("logid").toString();

                    String qry = "SELECT NAME,AID,Gender,WardNo,Email,Phone FROM regasha WHERE`PID`='" + pid + "'";
                ...
                <center>
                    <form method="post" action="../process/PanProfieEditAction.jsp" >
                        <table id="cstable" style="width:100%">
                            ...
                            %>
                            <tr><td><%=i%></td><td align="center"><%=(v.get(0))%></td>
                                <td align="center"><%=(v.get(2))%></td>
                                <td align="center"><%=(v.get(3))%></td>
                                <td align="center"><%=(v.get(4))%></td>
                                <td align="center"><%=(v.get(5))%></td>
                                <td align="center"><a href="../process/proPanDeleteAsha.jsp?aid=<%=(v.get(1))%>"><input type="button" value="Delete"></a></td>
