    ...
    <form method="post" action="../process/PanUpdateProgAction.jsp?progId=<%=progId%>" >
        <table id="cstable">
            ...
            <tr>
                <td>
                    Name Of Program </td>
                <td><input type="text" pattern="[A-Z a-z .]+" title="Characters only " name="PanProgName" value="<%=(v.get(0))%>" class="form-control1" id="focusedinput" required=""/></td> 
            </tr>

            <tr>
                <td>
                    Program Location </td>
                <td><input type="text"pattern="[A-Z a-z .]+" title="Characters only "  name="PanProLoc" value="<%=(v.get(1))%>"class="form-control1" id="focusedinput" required=""/></td> 
            </tr>
            <tr>
                    <td>
                        Date </td>    
            ...
            <tr>
                    <td>
                        Program Details </td>
                    <td><textarea name="ProgDet" pattern="[A-Z a-z .]+" title="Characters only " class="form-control1" id="focusedinput" required=""> <%=(v.get(4))%></textarea></td><br>
                </tr>
