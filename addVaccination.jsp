...
<body> 
	...
	<div class="services agileits-w3layouts">
		<div class="container">
			<h3 class="agileits-title1">ADD VACCINATION</h3>  
				<center>
        <form method="post" action="../process/proPanAddVacciAction.jsp" >
            <table id="cstable" style="width:70%">
                
                <tr>
                    <td>
                        Vaccination Name </td>
                    <td><input type="text" name="panVacciName" pattern="[A-Z a-z .]+" title="Characters only " class="form-control1" id="focusedinput" required=""/></td> 
                </tr>
                ...
                <tr>
                    ...
                    <td><textarea name="vacciDetails" pattern="[A-Z a-z .]+" title="Characters only " class="form-control1" id="txtarea1" required=""></textarea></td>  
                </tr>
                    ...
                    <td colspan="2" align="center">
                        <input type="submit" value="Add" id="btn" name="addVacci"/>
                    </td>
                </tr>
            </table>
        </form>
