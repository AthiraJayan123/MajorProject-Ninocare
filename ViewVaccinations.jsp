        ...
        <script>
            function getProgram(progId, pid)
            {
                ...
                if (obj != null)
                {
                    ...
                    obj.open('post', 'AjaxDisvacci.jsp?progId=' + progId + '&pid=' + pid, true);
                    obj.send(null);
                }
            }
                ...
                <center>
                    <form method="post">
                        <table id="cstable" style="width:100%">
                            ...
                            <th align="center">Vaccination Name</th>
                            ...
                            <tr><td><%=i%></td>
                                ...
                                <td align="center"><a href="#dispandiv1"><input type="button" value="EDIT" id="btns1" onclick="getProgram(<%=(v.get(0))%>)"></a></td><td><a href="../process/proPanDeleteVacciAction.jsp?vacciId=<%=(v.get(0))%>"/><input type="button" id="btns2"  value="DELETE"/></a></td>
